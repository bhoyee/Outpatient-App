    ...
    public class AppointmentController : Controller
    {
        ...
        public IActionResult BookNow(string dateOfBirth, string surname, string postcode)
        {
            try
            {
                ...
                {
                    // Duplicate appointment found
                    _logger.LogInformation($"Duplicate appointment found. Patient ID: {existingAppointment.Appointment.PatientID}, Shedule time: {existingAppointment.Appointment.ScheduledTime}");
